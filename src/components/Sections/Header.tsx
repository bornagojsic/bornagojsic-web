...
const Header: FC = memo(() => {
  ...
  const navSections = useMemo(
    () => [/* SectionId.Hero, */ SectionId.About, SectionId.Portfolio, SectionId.Contact],
    [],
  );
...
const DesktopNav: FC<{navSections: SectionId[]; currentSection: SectionId | null}> = memo(
  ({navSections, currentSection}) => {
    ...
    return (
      <header className="fixed top-0 z-50 hidden w-full bg-sky-800/50 p-4 backdrop-blur sm:block" id={headerID}>
...
const MobileNav: FC<{navSections: SectionId[]; currentSection: SectionId | null}> = memo(
  ({navSections, currentSection}) => {
    ...
    const activeClass = classNames(baseClass, 'bg-sky-900 text-white font-bold');
        ...
        <Transition.Root as={Fragment} show={isOpen}>
          <Dialog as="div" className="fixed inset-0 z-40 flex sm:hidden" onClose={toggleOpen}>
            ...
            <Transition.Child
              ...
              <div className="relative w-4/5 bg-sky-800">
