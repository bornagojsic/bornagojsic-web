...
const Contact: FC = memo(() => {
  ...
  return (
    <Section className="bg-cyan-400" sectionId={SectionId.Contact}>
      <div className="flex flex-col gap-y-6">
        <div className="flex flex-col gap-6 md:flex-row md:items-center">
          <EnvelopeIcon className="hidden h-16 w-16 text-neutral-100 md:block" />
          <h2 className="text-2xl font-bold text-neutral-100">{headerText}</h2>
        </div>
                    ...
                    <dd className="flex items-center">
                      <a
                        className={classNames(
                          '-m-2 flex rounded-md p-2 text-neutral-100 hover:text-orange-500',
                          {'hover:text-neutral-0': href},
                        )}
                        href={href}
                        target="_blank">
